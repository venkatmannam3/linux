...
/*
 * Primary Proc-based(ENTRY) capabilities
 * SDM volume 3C, section 24.7.1
 */
...
/*
 * Primary Proc-based(EXIT) capabilities
 * SDM volume 3C, section 24.8.1
 */
