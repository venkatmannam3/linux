...
atomic64_t total_exits = ATOMIC64_INIT(0);
EXPORT_SYMBOL(total_exits);

atomic64_t exits_time = ATOMIC64_INIT(0);
EXPORT_SYMBOL(exits_time);
...
/* ***  Return the total number of exits (all types) in %eax *** */
		...
		printk("eax is 0x4fffffff \n Total number of exits eax=%u", eax);
...
/* ***	Return the High 32 bits of the total time spent processing all exits in %ebx *** */	
		...
		printk("eax is 0x4ffffffe \n The High 32 bits of the Total time spent processing all exits in ebx = %u", ebx);

/* ***	Return the Low 32 bits of the total time spent processing all exits in %ecx *** */			
		ecx = (atomic64_read(&cycles_spent_in_exit)&0xffffffff);
		printk("eax is 0x4ffffffe \n The Low 32 bits of the Total time spent processing all exits in ecx = %u", ecx);
